...
export const issueBook = (bookId, userId) => axios.post(`${API_URL}/library/issue/${bookId}`, { userId });
export const returnBook = (bookId, userId) => axios.post(`${API_URL}/library/return/${bookId}`, { userId });
